...
<p align="center">
  ...
  <a href="https://github.com/Nikita112jj/LogicArrowsLauncher/releases/latest"><img src="https://img.shields.io/badge/Версия-1.4.8-7d5cff?style=for-the-badge" alt="Версия 1.4.5"></a>
...
> **О версии:** бейдж выше показывает актуальный релиз (сейчас — **v1.4.8**). Лаунчер сам проверяет свежий релиз на GitHub при запуске и обновляется одной кнопкой — перекачивать установщик вручную не нужно. История изменений — в [CHANGELOG.md](CHANGELOG.md).
