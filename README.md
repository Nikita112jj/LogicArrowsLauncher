...
В v1.0.7 исправлена тёмная тема: карточки карт и карточка **«Импорт .map»** больше не белые, текст стал контрастным, игровой renderer оставлен штатным в обеих темах, а тёмный стиль применяется к меню, inventory, toolbar, bind-подсказкам и FPS/TPS HUD. В настройках убраны лишние полоски, а блок **«Выйти»** теперь полностью закруглён.
